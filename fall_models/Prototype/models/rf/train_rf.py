...
def train_random_forest_once(
    *,
    ...
    payload = {
        "model": clf,
        # RF sklearn feature extraction metadata
        "feature_mode": str(rf_feature_mode),
        ...
        # Window preprocessing metadata (for eval parity)
        ...
        "preprocess_feature_mode": str(feature_mode),
