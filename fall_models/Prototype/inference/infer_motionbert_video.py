...
- You can pass paths relative to:
    ...
    python -m inference.infer_motionbert_video --video ../../Datasets/test_vids/sitting.mp4 --model ../../web_app/models/classification/MotionBERT/yolo11l-pose/checkpoint/action/FT_MB_release_MB_ft_UPFall_xsub/best_epoch.bin --config configs/action/MB_ft_UPFall_xsub.yaml --yolo-weights ../../quantisation/models/ultralytics/yolo11l-pose/yolo11l-pose_int8.engine --device cuda --benchmark 1 --profile-out benchmarks --no-display 1
