...
def build_arg_parser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser(description="Shared temporal inference wrapper using ViTPose keypoints.")
    ...
    ap.add_argument("--vitpose-conf", "--conf-thres", dest="vitpose_conf", type=float, default=0.25)
